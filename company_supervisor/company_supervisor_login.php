        ...
        <div class = "panel-body pbody">
          <div class="panel">
           <div class="panel-body pbody_login_holder">
             ...
             <hr>
                  <input type="password" class="form-control form-control-adjusted" id="txtcompany_supervisor_password" name="txtcompany_supervisor_password" placeholder="Enter Password"/><br>
                <div id="btn_login_holder">
                <input type="submit" class="btn btn-primary" value="Login" id="btn_supervisor_login" name="btn_login"/>
            </div>
