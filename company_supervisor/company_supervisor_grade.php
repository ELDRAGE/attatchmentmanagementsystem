...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="company_supervisor_login.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Company Supervisor</li></a>
