...
if(isset($_POST["btn_submit"])){
	...
	if($execute_mysql_query1 = mysqli_query($conn,$mysql_query1)){
		...
		if($check_existence==1){
			$mysql_query3 = "UPDATE `industrial_registration` SET `visiting_supervisor_grade` = '$grade_score' WHERE index_number = '$student_index_number'";
		...
		if($check_existence2==1){
			$mysql_query5 = "UPDATE `vira_registration` SET `visiting_supervisor_grade` = '$grade_score' WHERE index_number = '$student_index_number'";
...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="visiting_supervisor_login.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Visiting Supervisor</li></a>
  <a class="menu_items_link" href="../submit_report/submit_report.php"><li class="menu_items_list">Submit Report</li></a>
  <a class="menu_items_link" href="../login/index.php"><li class="menu_items_list">Logout</li></a>
</ul>
</div>
       ...
       <div class = "panel-heading phead">
        ...
        <div class = "panel-body pbody">
          ...
          <table class="table table-bordered">
            ...
            <caption><strong><u> DIRECTIONS </u> &nbsp; : </strong>&nbsp;Please indicate by clicking the options below to indicate the degree to which the student best measures up to the competencies stated below</caption>
             <tr >
                  <td rowspan="2" style="padding-top:30px;padding-bottom:20px;text-align:center;width:60%"> COMPETENCIES </td>
                  <td style="width:40%" colspan="6"> 0&nbsp;-&nbsp;ABSENT &nbsp;&nbsp;&nbsp;&nbsp;  1&nbsp;-&nbsp;WEAK &nbsp;&nbsp; 2&nbsp;-&nbsp;BELOW AVERAGE</td>
             </tr>
             <tr>
                  <td colspan="6"> 3&nbsp;-&nbsp;AVERAGE  &nbsp;&nbsp; 4&nbsp;-&nbsp;GOOD &nbsp;&nbsp; 5&nbsp;-&nbsp;OUTSTANDING</td>
             </tr>
             ...
             <tr style="text-align:center;font-weight:bold">
              ...
              <tr style="font-weight:bold">
                  <td colspan="7" style="font-weight:bold">A. &nbsp; SPECIFIC SKILLS ( Skills related to work assigned to student )</td>
              </tr>

          <tr style="text-align:center">
            <td><input type="text" class="form-control form-control-adjusted-company" name="txtSpecific_Skill_1" id="txtSpecific_Skill_1" placeholder="Enter first specific skill"></td>
          ...
          <tr style="text-align:center">
            <td><input type="text" class="form-control form-control-adjusted-company" name="txtSpecific_Skill_2" id="txtSpecific_Skill_2" placeholder="Enter second specific skill"></td>
          ...
          <tr style="text-align:center">
            <td><input type="text" class="form-control form-control-adjusted-company" name="txtSpecific_Skill_3" id="txtSpecific_Skill_3" placeholder="Enter third specific skill"></td>
          ...
          <tr style="text-align:center">
            <td><input type="text" class="form-control form-control-adjusted-company" name="txtSpecific_Skill_4" id="txtSpecific_Skill_4" placeholder="Enter fourth specific skill"></td>
          ...
          <tr style="text-align:center">
            <td><input type="text" class="form-control form-control-adjusted-company" name="txtSpecific_Skill_5" id="txtSpecific_Skill_5" placeholder="Enter fifth specific skill"></td>
          ...
          <tr>
            ...
            <input type="submit" value="Submit" name="btn_submit" id="btn_submit" class="btn btn-primary btn-sm" style="float:right"/>
            </form>
         </div>
     </div>
