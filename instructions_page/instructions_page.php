...
$student_fname = isset($_COOKIE["student_first_name"]) ? $_COOKIE["student_first_name"] : 'Unknown';
$student_lname = isset($_COOKIE["student_last_name"]) ? $_COOKIE["student_last_name"] : 'Unknown';
$student_index_number = isset($_COOKIE["student_index_number"]) ? $_COOKIE["student_index_number"] : 'Unknown';

// Check if the index number is set
if ($student_index_number !== 'Unknown') {
    ...
    if ($execute_check_supervisor_assigned) {
        ...
        if ($check_presence == 1) {
            ...
            $student_faculty = isset($get_entire_results["faculty"]) ? $get_entire_results["faculty"] : 'Unknown';
            $student_company_region = isset($get_entire_results["attachment_region"]) ? $get_entire_results["attachment_region"] : 'Unknown';
            $student_visiting_supervisor_name = isset($get_entire_results["visiting_supervisor_name"]) ? $get_entire_results["visiting_supervisor_name"] : 'Unknown';
            ...
            if ($student_company_region != "unassigned" && $student_visiting_supervisor_name != "unassigned") {
                ...
                if ($execute_get_supervisor_contact) {
                    $get_supervisors_contact = mysqli_fetch_array($execute_get_supervisor_contact);
                    $lecturers_contact = isset($get_supervisors_contact["lecturer_phone_number"]) ? $get_supervisors_contact["lecturer_phone_number"] : 'Unknown';
...
<div class="col-lg-3 col-md-4 col-sm-6">
  <div class = "panel">
     ...
     <div class = "panel-body pbody">
        <span>There are two (2) options, choose <span style="font-weight:bold;color:#2B3775">VIRA</span>
        if you a interning in the school or <span style="font-weight:bold;color:#2B3775">INDUSTRIAL</span>
      if you are interning with a company of your choice.</span>
      <br><br>
     </div>
  </div>
</div>
...
<div class="col-lg-3 col-md-4 col-sm-6">
  <div class = "panel">
     ...
     <div class = "panel-body pbody">
        <span>In case you select <span style="font-weight:bold;color:#2B3775">VIRA</span> in Step 2,
      you will be asked to enter your receipt number and click on <span style="font-weight:bold;color:#2B3775">VALIDATE</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
  <div class = "panel">
     ...
     you will be provided with a form to fill after which you should click on <span style="font-weight:bold;color:#2B3775">SUBMIT</span>
      to submit the form to the Liason Office</span>
     </div>
  </div>
</div>
</div>
...
<div class="col-lg-3 col-md-4 col-sm-6">
  <div class = "panel">
     ...
     <div class = "panel-body pbody">
        <span>Once you have clicked on <span style="font-weight:bold;color:#2B3775">Submit Assumption</span> in Step 5</span>,
        a form will be given to you fill after which you have to click on <span style="font-weight:bold;color:#2B3775">SUBMIT</span>
        to submit it to the Liason Office.
        <br><br><br>
     </div>
  </div>
</div>
