...
if(isset($_POST["btn-check-receipt"])){
    $entered_receipt_number = mysqli_real_escape_string($conn, $_POST["txtreceipt"]);
    
    // Check receipt number against the course_creation table
    $check_receipt = "SELECT * FROM course_creation WHERE randomstring='$entered_receipt_number'";
...
if(isset($_POST["btn_submit"])){
    if($_POST["student_programme"] != "" && $_POST["student_level"] != "" && $_POST["student_session"] != ""){
        ...
        if($check_user == 1){
            ...
            if(mysqli_query($conn, $insert_details_command)){
...
<ul id="menu_list">
    ...
    <a class="menu_items_link" href="../student_assumption/student_assumption.php"><li class="menu_items_list">Submit Assumption</li></a>
                    ...
                    <div class="panel-body">
                        <form method="post" action="">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-adjusted" id="txtfname" placeholder="Enter first name" disabled value="<?php echo htmlspecialchars($first_name_holder); ?>">
                            </div>

                            <div class="form-group">
                                <label for="txtlname">Last Name </label>
                                <input type="text" class="form-control form-control-adjusted" id="txtlname" placeholder="Enter last name" disabled value="<?php echo htmlspecialchars($last_name_holder); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-adjusted" id="txtindexnumber" placeholder="Enter index number" name="txt_index_number" <?php echo $index_status; ?> value="<?php echo htmlspecialchars($index_number_holder); ?>">
                            </div>
