...
$check_content_existence = "SELECT * FROM week4_table WHERE index_number='$student_index_number'";
    ...
    <div class = "panel">
      ...
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <ul class = "pager">
             <li class = "previous"><a href = "elogbook_week3.php">&larr; Previous</a></li>
             <li class = "next"><a href = "elogbook_week5.php">Next &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
          <span style="font-size:1.3em;font-weight:bold;">Week 4</span>
        </div>
        <hr>
