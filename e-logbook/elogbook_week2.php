...
$check_content_existence = "SELECT * FROM week2_table WHERE index_number='$student_index_number' LIMIT 1";
    ...
    <div class = "panel">
      ...
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <ul class = "pager">
             <li class = "previous"><a href = "elogbook.php">&larr; Previous</a></li>
             <li class = "next"><a href = "elogbook_week3.php">Next &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
          <span style="font-size:1.3em;font-weight:bold;">Week 2</span>
        </div>
        <hr>
...
// Assuming $conn is your database connection and $student_index_number is defined
$student_index_number = mysqli_real_escape_string($conn, $student_index_number);

// Query to fetch data
$get_previous_data = "SELECT * FROM week2_table WHERE index_number='$student_index_number'";
